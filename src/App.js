...
//   <div className="text-center" style={{ backgroundColor: bgColor }}>
//     <br />
//     <div className="  py-10 mx-20 border-4 border-double rounded-3xl border-orange-950">
